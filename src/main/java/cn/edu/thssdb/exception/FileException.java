...
public class FileException extends RuntimeException {
  ...
  public String getMessage() {
    if (exception_type == FileNotFound) return "Exception: file \'" + file_name + "\' not found!";
    if (exception_type == Create) return "Exception: failed to create file \'" + file_name + "\'!";
    if (exception_type == Delete) return "Exception: failed to delete file \'" + file_name + "\'!";
    if (exception_type == Open) return "Exception: failed to open file \'" + file_name + "\'!";
